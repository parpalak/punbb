...
$lang_pun_antispam = array(
	...
	'Captcha Info'					=>	'Защита от автоматических регистраций и перебора паролей. Пожалуйста, введите латинские буквы и цифры, изображённые на картинке.',
	'img alt'						=>	'Изображение с буквами. Включите картинки, чтобы увидеть их.',
	'Invalid Text'					=>	'Вы ввели неправильный защитный код.',
	'No cookies'					=>	'Не удалось проверить защитный код. Скорее всего в вашем браузере выключены cookies. Проверьте настройку браузера и включите их.',

	'reload image'					=>	'(обновить картинку)',
